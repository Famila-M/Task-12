var app_id = "4d7aee8a";
var app_key = "ac4f8efca7f4c831f6bb80caf9554733";
...
heading.setAttribute("style","color:#009933;font-size:50px;font-family:cursive;font-style:italic;");
heading.innerHTML = "&nbsp;&nbsp;Food-Street <hr>";
...
label.innerHTML = "Delicious Food Recipe";
...
async function callapi(){
    ...
    try{
        ...
        container3.innerHTML = `<hr> <h3>Food-Street gives some of the recipes for ${query}...</h3> <br> <br>`;
